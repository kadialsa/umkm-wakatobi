...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.slide.updete') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        @if ($slide->image)
                            <div class="item" id="imgpreview" style="display: 500px;">
